...
export const PRIVACY_NOTICE_VERSION = "v1.1" as const;
export const PRIVACY_NOTICE_SUMMARY =
  "Admin X 仅在管理后台运行所必需的范围内处理账号、权限、通知和安全审计相关信息，并提供查阅、更正、导出和注销等权利。";
export const PRIVACY_NOTICE_DETAILS = [
  {
    title: "一、处理范围与联系途径",
    content:
      "本系统面向组织内部管理场景，由部署和运营本系统的单位负责个人信息处理。账号、权限或个人信息相关事项，可通过本单位系统管理员提出申请或咨询。",
  },
  {
    title: "二、收集和处理的信息",
    content:
  ...
  },
  {
    title: "四、保存期限和到期处理",
    content:
      "账号资料在账号存续及实现管理目的所必要的期限内保存；访问记录、登录 IP、告知确认 IP、邮箱验证码挑战和登录会话按照安全策略保存，辅助信息清理期限默认为 365 天。失效会话和过期验证码会及时清理；账号注销后，业务个人资料会被删除，法律法规或安全审计确有必要保留的记录将在必要期限内保留并采取相应保护措施。",
  },
  {
    title: "五、共享、委托和邮箱服务",
    content:
  ...
  },
  {
    title: "七、你的权利",
    content:
      "在符合法律法规和系统管理规则的前提下，你可以通过个人资料页面查看和更正个人资料，申请导出个人资料及相关审计记录，或在完成身份确认后申请注销账号。历史账号在告知版本更新后，需要重新阅读并确认最新版本。",
  },
  {
    title: "八、告知更新",
    content:
      "当处理目的、信息范围、保存期限或权利行使方式发生变化时，系统会更新告知版本并提示重新确认。你可以在确认前阅读本告知内容；不同意必要处理事项可能无法创建或继续使用管理账号。",
  },
] as const;
